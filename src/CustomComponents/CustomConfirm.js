...
const CustomConfirm = ({ visible, children, confirmCallback, maskClosable, cancelCallback, okLoading, footer, centered, closable, style, className }) => {
    return <Modal visible={visible} closable={closable || false} onOk={confirmCallback} confirmLoading={okLoading} onCancel={cancelCallback}
        ...
        <div className={"custom-modal-content-container" + (className || '')} style={{...style}}>
            {children}
        </div>
