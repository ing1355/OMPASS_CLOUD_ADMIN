      ...
      <div className="document-text-box">
        ...
        <div className="documnet-box">
          <div className="document-label">
            ...
            <p>
              <FormattedMessage id="OMPASS 인증을 적용하고 있는 웹페이지에서 ID/PW 입력 후 인터페이스 팝업 창이 뜨면 ‘OMPASS 앱’ 버튼을 선택합니다." />
            </p>
          </div>
          <div className="document-label">
            <label className="number number-2">❸-⑵&nbsp;</label>
            <p>
              <FormattedMessage id="OMPASS 인증장치 등록 QR코드 창이 열립니다." />
            </p>
          </div>
          <div className="document-label">
            <label className="number number-2">❸-⑶&nbsp;</label>
            <p>
              <FormattedMessage id="OMPASS 앱에서 버튼을 누릅니다." />
            </p>
          </div>
          <div className="document-label">
            <label className="number number-2">❸-⑷&nbsp;</label>
            <p>
              <FormattedMessage id="QR 코드를 스캔합니다." />
            </p>
          </div>
      ...
      <div className="document-text-box">
        ...
        <div className="documnet-box">
          <div className="document-label">
            <label className="number number-2">❹-⑴&nbsp;</label>
            <p>
              <FormattedMessage id="OMPASS 인증을 적용하고 있는 웹페이지에서 ID/PW 입력 하면 자동으로 알림 전송이 됩니다." />
            </p>
          </div>
          <div className="document-label">
            <label className="number number-2">❹-⑵&nbsp;</label>
          ...
          <div className="document-label-notice">
            <div>
              <label>*&nbsp;</label>
              <p>
                <FormattedMessage id="OMPASS 인증 알림이 오지 않는 경우" />
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="documnet-box">
          <div className="document-label">
            ...
            <p>
              <FormattedMessage id="“QR코드로 로그인 하기”버튼을 클릭합니다." />
            </p>
          </div>
          <div className="document-label">
            <label className="number">❷&nbsp;</label>
            <p>
            <FormattedMessage id="QR 코드를 생성합니다." />
            </p>
          </div>
          <div className="document-label">
            <label className="number">❸&nbsp;</label>
