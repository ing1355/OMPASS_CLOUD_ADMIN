...
const AdminManagement = () => {
  ...
  return (
    <div>
      <h4>▶ <FormattedMessage id="관리자 관리" /></h4>
      ...
      <div className="document-text-box">
        ...
        <div className="documnet-box">
          <div className="document-label">
            ...
            <p><FormattedMessage id="관리자 추가 등록이 가능합니다." /></p>
          </div>
          <div className="document-label">
            <label className="number">❷&nbsp;</label>
            <p><FormattedMessage id="관리자 정보를 제공합니다." /></p>
          </div>
        </div>
      </div>
      {/* =================================================================== */}
      ...
      <div className="document-text-box">
        ...
        >
          <label>↓&nbsp;</label>
          <p><FormattedMessage id="관리자 목록 클릭 시" /></p>
        </div>
        <div className="document-img">
          <img
            width="100%"
        ...
        <div className="documnet-box">
          <div className="document-label">
            <label className="number">❶&nbsp;</label>
            <p><FormattedMessage id="관리자 상세정보가 표기됩니다." /></p>
          </div>
          <div className="document-label">
            <label className="number">❷&nbsp;</label>
            <p><FormattedMessage id="관리자 정보 수정이 가능합니다." /></p>
          </div>
          <div className="document-label">
            <label>* &nbsp;</label>
            <p>
              <FormattedMessage id="현재 로그인 된 계정의 비밀번호만 수정이 가능합니다." />
              <br />(<FormattedMessage id="비밀번호는 문자, 숫자, 특수문자를 활용하여 최대 16자리 까지 8자 이상 3가지 조합 또는 10자 이상 2가지 조합으로 입력해야 합니다." />)
            </p>
          </div>
          <div className="document-label">
            <label className="number">❸&nbsp;</label>
            <span style={{padding: '1rem 0 0'}}>
              <b>
                <FormattedMessage id="로그인한 계정이" />{" "}
                <b style={{ textDecoration: "underline" }}>
                  <FormattedMessage id="Admin 계정" />
                </b>
                <FormattedMessage id="인 경우 해당 버튼이 보여집니다." />
              </b>
              <div className="document-label">
                <label>→ &nbsp;</label>
                <p><FormattedMessage id="본인 계정 선택 시 “회원 탈퇴” 버튼이 보여지며, OMPASS 서비스 탈퇴가 가능합니다." /></p>
              </div>
              <div className="document-label">
                <label>→ &nbsp;</label>
                <p><FormattedMessage id="Sub Admin 선택 시 “삭제” 버튼이 보여지며, Sub Admin 삭제가 가능합니다." /></p>
              </div>
              <div className="document-label">
                <label>→ &nbsp;</label>
                <p><FormattedMessage id="기본으로 제공되는 ADMIN 계정은 삭제 및 회원탈퇴가 불가능합니다."/></p>
              </div>
            </span>
          </div>
        </div>
        ...
        <div className="document-img">
          <img
            width="55%"
            src={isKorea(locale) ? adminImg3Kr : adminImg3En}
            alt="관리자 페이지"
          />
        </div>
        ...
        <div className="documnet-box">
          <div className="document-label">
            <label className="number">❹&nbsp;</label>
            <p><FormattedMessage id="비밀번호 입력 후 회원 탈퇴가 완료됩니다." /></p>
          </div>
        </div>
      </div>
      ...
      <div className="document-text-box">
        ...
        >
          <label>↓&nbsp;</label>
          <p><FormattedMessage id="관리자 등록 버튼 클릭 시" /></p>
        </div>
        <div className="document-img">
          <img
            width="100%"
      ...
      <div className="document-text-box">
        ...
        >
          <label>↓&nbsp;</label>
          <p><FormattedMessage id="관리자 등록 인증 메일" /></p>
        </div>
        <div className="document-img">
          <img
            width="100%"
