    ...
    CustomAxiosPost(
      ...
      ({ planId }) => {
        ...
        if (window.paypal) callback();
          ...
          script.src = 'https://www.paypal.com/sdk/js?client-id=AQVVRFHUuvzwlXTe5w054LaT3JvZxAQPw-zxcgQHDzm1skXH2e2M8cfKP_O8oO3xnRbV86uUyF0dfriY&vault=true&intent=subscription'
    ...
    <div className="contents-container">
      ...
      <section className="billing-change-container">
        <h2>
          ...
          {currentPlan && currentPlan.status === 'RUN' && tableData.length > 0 && (currentPlan.numberUsers !== tableData[0].numberUsers) &&
