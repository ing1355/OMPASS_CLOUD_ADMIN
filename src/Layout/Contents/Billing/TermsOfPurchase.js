...
const TermsOfPurchase = ({ visible, setVisible }) => {
    ...
    >
        <p>이용약관</p>
        <p>제1조 목적</p>
        <p>본 이용약관은 ㈜원모어시큐리티(이하 "회사")가 운영하는 원모어패스(OMPASS) 어플리케이션(이하 "서비스"), 원모어패스 클라우드 관리자(관리자 페이지)(이하 "사이트")의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.</p>
        <p>제2조 용어의 정의</p>
        <p>본 약관에서 사용되는 주요한 용어의 정의는 다음과 같습니다.</p>
        <p>
            ① 회원 : 회원은 관리자(ADMIN)(이하 "관리자"), 서브관리자(SUB_ADMIN)(이하 "서브관리자"), 사용자로 구분되며 서비스가 적용된 어플리케이션에 첫 로그인 시 휴대폰 본인 인증을 진행합니다.<br />
            ② 관리자 : 서비스 및 사이트의 약관에 동의하고 개인정보를 제공하여 회원등록을 한 자로서, 서비스 및 사이트와의 이용계약을 체결, 관리, 이용하는 이용자를 말합니다.<br />
            ③ 서브관리자 : 관리자에 의해 등록되어 이메일 본인 인증을 완료한 자로서, 서비스 및 사이트를 관리하고 이용하는 이용자를 말합니다.<br />
            ④ 사용자 : 적용된 어플리케이션에 로그인을 위해 서비스를 이용하는 이용자를 말합니다.<br />
            ⑤ 운영자 : 서비스 및 사이트에 대한 어플리케이션 및 홈페이지를 개설하여 운영하는 운영자를 말합니다.<br />
            ⑥ 사용자 아이디(이하 "ID") : 회원의 식별과 회원의 서비스 이용을 위하여 회원별로 부여하는 고유한 문자와 숫자의 조합을 말합니다. 등록한 어플리케이션에 해당하는 아이디가 대쉬보드, 로그, 사용자 관리에 노출되며 본 사이트의 사용자 아이디는 등록한 이메일 주소로 노출됩니다.<br />
            ⑦ 비밀번호 : 회원의 부여받은 ID와 일치된 회원임을 확인하고 회원의 권익 보호를 위하여 회원이 선정한 문자와 숫자의 조합을 말합니다.<br />
            ⑧ 이용계약 : 서비스 및 사이트 이용과 관련하여 회사와 회원간에 체결 하는 계약을 말합니다.<br />
        ...
        <p id="purchaseTarget">제4조 이용계약 체결 및 구매조건</p>
        <p>
            ① 이용계약은 회원으로 등록하여 사이트를 이용하려는 관리자의 본 약관 내용에 대한 동의와 가입신청에 대하여 운영자의 이용승낙으로 이용계약 체결을 성립합니다.<br />
            ② 회원(관리자)으로 등록하여 서비스를 이용하려는 자는 사이트 가입신청 시 본 약관을 읽고 동의를 선택하는 것으로 본 약관에 대한 동의 의사 표시를 합니다.<br />
            ③ 결제 전 본 약관을 읽고 동의를 선택하는 것으로 구매조건 확인 및 결제진행에 대한 동의 의사 표시를 합니다.<br />
            ③ 구매조건으로서 사용자 10인 이하는 무료이며 11인 이상은 결제 후 서비스 및 사이트를 이용할 수 있습니다.<br />
            ④ 구매조건으로서 사용자 11인 이상은 결제일로 부터 월 30일 또는 년 365일 주기로 선택하여 사용자 1인 당 2,200원을 결제하여 정기결제(자동결제)를 신청함과 동시에 서비스 및 사이트를 이용할 수 있습니다.<br />
            ⑤ 구독 취소를 통해 정기결제를 취소할 수 있으며 남은 기간 동안 서비스 및 사이트 이용이 가능합니다. 재결제 시 정기결제가 다시 활성화 됩니다.<br />
            ⑥ 결제된 사용자 수를 변경하면 적용된 사용자 수에 따른 결제는 당일이 아닌 다음 결제일에 적용된 총 결제 인원으로 계산되어 정기결제(자동결제)가 진행됩니다.
        </p>
        <p>제5조 청약 철회(환불 규정)</p>
        <p>
            ① 회원이 서비스 및 사이트와의 이용계약을 해지하고자 하는 경우에는 회원 본인이 온라인을 통하여 청약 철회신청을 하여야 합니다.<br />
            ② 구독 취소는 청약 철회가 아닌 정기결제를 취소하는 것을 말하며 구독 취소 후에는 사용 만료일까지 사용이 가능합니다.<br />
            ③ 해당 결제일(결제 날짜)로부터 7일 이내에 청약 철회를 신청하면 신청일로 부터 익월 말일까지 결제금액의 100% 가 환불됩니다.
        </p>
        <p>제6조 서비스 이용 신청</p>
        <p>
            ① 회원으로 등록하여 서비스 및 사이트를 이용하려는 관리자는 사이트에서 요청하는 제반정보(성, 이름, 이메일주소, 국가코드, 전화번호, 회사이름)를 제공해야 합니다.<br />
            ② 타인의 정보를 도용하거나 허위의 정보를 등록하는 등 본인의 진정한 정보를 등록하지 않은 회원은 사이트 이용과 관련하여 아무런 권리를 주장할 수 없으며, 관계 법령에 따라 처벌받을 수 있습니다.
        </p>
        <p>제7조 개인정보처리방침</p>
        <p>
            서비스, 사이트 및 운영자는 회원가입 시 제공한 개인정보 중 비밀번호를 가지고 있지 않으며 이와 관련된 부분은 사이트의 개인정보처리방침을 따릅니다.<br />
        ...
        <p>제8조 운영자의 의무</p>
        <p>
            ① 운영자는 회원으로부터 제기되는 의견이나 불만이 정당하다고 인정할 경우에는 가급적 빨리 처리하여야 합니다. 다만, 개인적인 사정으로 신속한 처리가 곤란한 경우에는 사후에 공지 또는 회원에게 이메일, 전화 등을 통한 연락 등 최선을 다합니다.<br />
        ...
        &nbsp;&nbsp;&nbsp;② 타인의 서비스 및 사이트 이용을 방해하거나 정보를 도용하는 행위<br />
        &nbsp;&nbsp;&nbsp;③ 서비스 및 사이트의 운영진, 직원 또는 관계자를 사칭하는 행위<br />
        &nbsp;&nbsp;&nbsp;④ 서비스 및 사이트, 기타 제3자의 인격권 또는 지적재산권을 침해하거나 업무를 방해하는 행위<br />
        ...
        <p>제12조 손해배상</p>
        <p>
            ① 본 서비스 및 사이트의 발생한 모든 민, 형법상 책임은 회원 본인에게 1차적으로 있습니다.<br />
        ...
        ③ 운영자는 회원이 저장, 등록 또는 업로드한 자료와 관련하여 일체의 책임을 지지 않습니다.<br />
