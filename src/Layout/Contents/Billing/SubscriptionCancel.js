...
import { cancelSubscriptionIamportApi, cancelSubscriptionPayPalApi } from "../../../Constants/Api_Route";
...
const SubscriptionCancel = ({ userProfile, showSuccessMessage, isKorea, setCurrentPlan, currentPlan, editions }) => {
    ...
    return <>
        ...
        >
            ...
            <div className="subscription-cancel-description">
                <FormattedMessage id="SUBSCRIPTION_CANCEL_DESCRIPTION" values={{
                    email,
                    date: currentPlan ? (isKorea() ? getDateFormatKr(currentPlan.expireDate) : getDateFormatEn(currentPlan.expireDate)) : null
                }}/>
            </div>
