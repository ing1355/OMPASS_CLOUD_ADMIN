...
import WebAuthnInfo from "./WebAuthnInfo";
...
const UserDetail = ({
  ...
  const { userId, byPass, appId, email, type, authDevice, register } = data;
      ...
      {Object.keys(data).length < 1 ? (
        ...
        <div className="ApplicationsBox">
          <form className="form-box" onSubmit={onFinish}>
            ...
            >
              <div className="ant-col-4 ant-form-item-label-left">
                <label><FormattedMessage id="DEVICE_INFO"/> : </label>
              </div>
              <div className="form-ul">
                {type === 'WEBAUTHN' ? <WebAuthnInfo data={authDevice}/> :<MobileInfo data={authDevice}/>}
              </div>
            </div>
