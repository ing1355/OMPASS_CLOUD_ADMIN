...
import { checkApplicationExistenceApi, deleteApplicationApi, getApplicationDetailApi, getApplicationDetailLogsApi, getNewSecretKeyApi, updateApplicationApi } from '../../../Constants/Api_Route';
import CustomTable from '../../../Constants/CustomTable';
import { CustomAxiosGet, CustomAxiosPatch, CustomAxiosPut, CustomAxiosDelete } from '../../../Functions/CustomAxios';
...
const ApplicationDetail = ({ userProfile, tableDataDelete }) => {
    ...
    return <>
        <form onSubmit={e => {
            ...
            CustomAxiosPut(updateApplicationApi(adminId, appId), {
                name: name.value,
                domain: domain.value,
            ...
            <div>
                ...
                <button type="button" disabled={isExistCheck} onClick={existCheck}>중복 체크</button>
            </div>
            <div>
            ...
            <div>
                ...
                <button type='button' onClick={resetSecretKey}>Reset Secret Key</button>
            </div>
            <div>
                <label>Domain</label>
                <input name="domain" value={inputDomain} onChange={changeInputDomain}/>
            </div>
            <div>
                <label>Redirect URI</label>
                <input name="redirectUri" value={inputRedirectURI} onChange={changeInputRedirectURI}/>
            </div>
            <div>
                <label>Status</label>
                <input name="status" value={inputStatus} onChange={changeInputStatus}/>
            </div>
            <button type="submit">수정</button>
            <button type="button" onClick={applicationDelete}>삭제</button>
        </form>
