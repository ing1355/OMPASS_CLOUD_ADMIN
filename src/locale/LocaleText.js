const locales = {
  US: {
    ...
    BILLINGCHECKDESCRIPTION: "I have read and agree to the Terms of Use and Privacy Policy",
    BILLINGPRICEDESCRIPTIONMONTHLY:
      "{param} is going to be automatically paid every 30 days from today.",
    BILLINGPRICEDESCRIPTIONANNUALY: "{param} is going to be automatically paid every 365 days from today.",
    ...
    ACCESSCONTROLDESCRIPTION:
      "Checking the box above will apply to all users.",
    ...
    OMPASSMOBILEPOLICYACTIVE: "Yes, users must require the latest security patches to access OMPASS.",
    ...
    NONEUSED: '사용하지 않음',
    INPUTEMAIL: '이메일 입력',
    USERBYPASSDESCRIPTION: 'OMPASS 인증 없이 로그인 가능합니다.',
    USERBYPASSDESCRIPTION2: '바이패스 비활성화 (디폴트)',
