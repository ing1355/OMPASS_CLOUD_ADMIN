const locales = {
  ...
  KR: {
    ...
    Sales_Level_Agreement_title1_2: "“고장 시간”은 고객의 모든 사용자에 대해 사용자 오류율이 5%를 초과하는 경우를 의미합니다. 고장 시간은 서버 측 오류율을 기준으로 측정됩니다.",
    Sales_Level_Agreement_title1_3: "“서비스”는 OMPASS FIDO 인증 서비스를 의미합니다.",
    Sales_Level_Agreement_title1_4: "“월별 가동율”은 30일 계약의 총 시간(분)에서 30일 계약 기간 내에 발생한 고장 시간(분)을 빼고, 30일 계약의 총 시간(분)으로 나눈 백분율을 의미합니다.",
    ...
    Sales_Level_Agreement_title3_1: "30일 계약 기간 내에 발생하는 모든 고장 시간에 대해 회사가 고객에게 발행할 서비스 크레딧의 최대 수는 서비스 15일을 초과할 수 없습니다. 서비스 크레딧은 금전적 금액으로 교환되거나 전환될 수 없습니다.",
